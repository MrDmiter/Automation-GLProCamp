...
public abstract class AbstractStudent {
    ...
    /**
     * Check whether data matches our conditions
     *
     * @param list
     * @return true if conditions are following, false otherwise
     */
    public boolean dataChecker(ArrayList<String> list) {
        if (list.get(0).equals("Keith Richards") && Integer.parseInt(list.get(1)) >= 17 && Integer.parseInt(list.get(1)) <= 25 && list.get(2).equals("Male")) {
            return true;
        }
        return false;
    }
